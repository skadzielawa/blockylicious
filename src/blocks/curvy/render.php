...
$bottom_transform = 'scaleX(' . ( $attributes['bottomFlipX'] ? '-1' : '1' ) . ') rotate(' . ( $attributes['bottomFlipY'] ? '180deg' : '0' ) . ') scaleY(-1)';
// wp_send_json($attributes);
?>

<div <?php echo $block_wrapper_attributes; ?>>
	<div class="curve top-curve"
		style="display: <?php echo $attributes['enableTopCurve'] ? 'block' : 'none'; ?>; height: <?php echo $attributes['topHeight']; ?>px; transform: <?php echo $top_transform; ?>;">
	...
	<div class="curve bottom-curve"
		style="display: <?php echo $attributes['enableBottomCurve'] ? 'block' : 'none'; ?>; height: <?php echo $attributes['bottomHeight']; ?>px; transform: <?php echo $bottom_transform; ?>;">
